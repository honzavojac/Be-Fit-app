...
class _FitnessRecordScreenState extends State<FitnessRecordScreen> {
  ...
  Future<void> refresh() async {
    ...
    a = 0;
    selectedSplit = dbSupabase.clickedSplitTab;
    await loadData();
    print("object");
    setState(() {});
  }
  ...
  @override
  Widget build(BuildContext context) {
    print("setstate aktualizoval fitness record page");
    var dbSupabase = Provider.of<SupabaseProvider>(context);
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: Padding(
                                                        ...
                                                        child: Container(
                                                          decoration: BoxDecoration(color: Color.fromARGB(117, 0, 0, 0), borderRadius: variablesProvider.zaobleni),
                                                          child: Row(
                                                            children: [
                                                              Padding(
