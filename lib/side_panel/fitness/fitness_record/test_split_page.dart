...
import 'test_split_save_listener.dart';
      ...
      builder: (context, state) {
        if (state is FitnessLoaded) {
          ...
          return TestSplitSaveListener(
            splits: splits,
            selectedMusclesMap: selectedMusclesMap,
                                        ...
                                        return Container(
                                          ...
                                          child: IntrinsicWidth(
                                            child: Padding(
                                              ...
                                              child: Center(
                                                  child: Text(
                                                '${record.supabaseIdSplit} ${record.nameSplit}'.toString(),
                                                style: TextStyle(
                                                  fontSize: 19,
                                                ),
                                              )),
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    ...
                                                                    (muscleExerciseMap[selectedMuscle.musclesIdMuscle] == null)
                                                                        ? Padding(
                                                                                ...
                                                                                itemBuilder: (context, itemIndex) {
                                                                                  ...
                                                                                  if (exerciseList != null) {
                                                                                    for (var element in exerciseList) {
                                                                                      if (element.idExercise == exercise.supabaseIdExercise && element.action != 3) {
                                                                                        print("ano");
                                                                                        ...
                                                                                        children: [
                                                                                          Expanded(
                                                                                            child: TextField(
                                                                                              ...
                                                                                              controller: TextEditingController(text: "${exercise.supabaseIdExercise} ${exercise.nameOfExercise}"),
                                                                                              minLines: 1,
                                                                                              maxLines: null,
                                                                                              decoration: InputDecoration(
                                                                                                filled: true,
                                                                                            ...
                                                                                            child: Center(
                                                                                              child: GestureDetector(
                                                                                                onTap: () async {
                                                                                                  ...
                                                                                                  _splitIndex = _tabController.index;
                                                                                                  context.read<FitnessBloc>().add(UpdateSelectedExerciseBloc(selectedMuscleId, exercise));
                                                                                                },
                                                                                                child: Container(
                                                                                                  width: 29,
                                                                                                  height: 29,
