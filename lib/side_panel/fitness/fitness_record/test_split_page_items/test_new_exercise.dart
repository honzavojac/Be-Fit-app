...
class TestNewExercise extends StatefulWidget {
  final Muscle muscle;
  const TestNewExercise({
    Key? key,
    required this.muscle,
  }) : super(key: key);

  @override
  _TestNewExerciseState createState() => _TestNewExerciseState();
}

class _TestNewExerciseState extends State<TestNewExercise> {
  @override
  ...
  Widget build(BuildContext context) {
    muscle == null ? muscle = widget.muscle : this.muscle;
                    ...
                    children: [
                      ...
                      DropdownButtonHideUnderline(
                        child: DropdownButton2<Muscle>(
                          isExpanded: true,
                          items: muscleMap.values.map<DropdownMenuItem<Muscle>>((Muscle muscle) {
